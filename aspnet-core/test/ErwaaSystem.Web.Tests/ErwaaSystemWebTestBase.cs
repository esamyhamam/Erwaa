...
using ErwaaSystem.Models.TokenAuth;
...
public abstract class ErwaaSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ErwaaSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ErwaaSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ErwaaSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ErwaaSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ErwaaSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ErwaaSystemDbContext, Task<T>> func)
    {
        T result;
